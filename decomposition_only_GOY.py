'''
This script performs decomposition only from the arbitrary set of FMSOs selected by the BILP for diagnosability.
'''
...
output_name = 'GOY_decomposition_only'
...
print('Decomposition only from the arbitrary FMSOs')
nd.run_without_decomposition_first(constraints=constraints, flow_small_weights=flow_small_weights, **dec_params)
nd.save_results()
